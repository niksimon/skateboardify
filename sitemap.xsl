...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sitemap="http://www.sitemaps.org/schemas/sitemap/0.9">
	<xsl:template match="/">
		<html lang="en-US">
			<head>
				<title>Sitemap - Skateboardify</title>
				<meta charset="utf-8"/>
				<meta name="viewport" content="width=device-width, initial-scale=1"/>
				<meta name="description" content="Skateboard shop for everything a skateboarder needs. Free shipping worldwide."/>
				<meta name="keywords" content="skateboardify, sitemap, skateboard, longboard, electric, board, trucks, wheels, shop"/>
